...
import id.ac.poliban.mi.va.erika.challengeshoppingitemsimplicitintents.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
            ...
            registerForActivityResult(new ActivityResultContracts.StartActivityForResult(),
                    result -> {
                        if (result.getResultCode() == RESULT_OK) {
                            ...
                            String item = intent.getStringExtra(KumpulanItemActivity.ITEM_TAG);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainBinding.addItem.setOnClickListener(v -> {
            Intent intent = new Intent(this, KumpulanItemActivity.class);
        ...
        mainBinding.buttonSearch.setOnClickListener(v -> {
            String loc = mainBinding.editTextSearch.getText().toString();
