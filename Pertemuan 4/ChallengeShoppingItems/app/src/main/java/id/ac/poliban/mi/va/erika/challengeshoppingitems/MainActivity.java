...
import id.ac.poliban.mi.va.erika.challengeshoppingitems.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
            ...
            registerForActivityResult(new ActivityResultContracts.StartActivityForResult(),
                    result -> {
                        if (result.getResultCode() == RESULT_OK) {
                            ...
                            String item = intent.getStringExtra(KumpulanItemsActivity.ITEM_TAG);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainBinding.addItem.setOnClickListener(v -> {
            Intent intent = new Intent(this, KumpulanItemsActivity.class);
